...
/** Check list. */
public final class MagikTypedCheckList extends CheckList<MagikCheck, MagikTypedCheckFixer> {
  ...
  @Override
  protected List<Class<? extends MagikCheck>> doGetChecks() {
    return List.of(
  ...
  @Override
  protected Map<Class<? extends MagikCheck>, List<Class<? extends MagikTypedCheckFixer>>>
      doGetFixers() {
    return Map.of(
