...
public final class MagikCheckList extends CheckList<MagikCheck, CheckFixer> {
  ...
  @Override
  protected Map<Class<? extends MagikCheck>, List<Class<? extends CheckFixer>>> doGetFixers() {
